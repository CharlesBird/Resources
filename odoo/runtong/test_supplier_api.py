...
#            </soapenv:Header>
#            <soapenv:Body>
#               <tem:RMS_VendTableServiceFindRequest>
#                  <!--Optional:-->
#                  <quer:QueryCriteria>
#                     <quer:CriteriaElement>
#                        <quer:DataSourceName>VendTable</quer:DataSourceName>
#                        <quer:FieldName>AccountNum</quer:FieldName>
#                        <quer:Operator>equal</quer:Operator>
#                        <quer:Value1>SCHN03151</quer:Value1>
#                        <!--Optional:-->
...
#            </soapenv:Body>
#         </soapenv:Envelope>'''
#     headers = [("SOAPAction", "http://tempuri.org/RMS_VendTableService/find"),
#                ("Content-Type", "text/xml;charset=utf-8")]
#     url = "http://172.70.0.49:801/MicrosoftDynamicsAXAif60/RMSVendTable/xppservice.svc"
#
