...
if __name__ == '__main__':
    data = '''
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:dat="http://schemas.microsoft.com/dynamics/2010/01/datacontracts" xmlns:arr="http://schemas.microsoft.com/2003/10/Serialization/Arrays" xmlns:tem="http://tempuri.org" xmlns:quer="http://schemas.microsoft.com/dynamics/2006/02/documents/QueryCriteria">
           ...
           <soapenv:Body>
              <tem:RMS_SalesTaskNoServiceFindRequest>
                 <!--Optional:-->
                 <quer:QueryCriteria>
                    <quer:CriteriaElement>
                       <quer:DataSourceName>VYA_SalestasknumberTable</quer:DataSourceName>
                       <quer:FieldName>SalesTaskNumber</quer:FieldName>
                       <quer:Operator>equal</quer:Operator>
                       <quer:Value1>SCPC99PC190417004</quer:Value1>
                       <!--Optional:-->
    ...
    headers = [("SOAPAction", "http://tempuri.org/RMS_SalesTaskNoService/find"),
               ("Content-Type", "text/xml;charset=utf-8")]
    url = "http://172.70.0.49:801/MicrosoftDynamicsAXAif60/RMSSalesTaskNo/xppservice.svc"
