...
#            </soapenv:Header>
#            <soapenv:Body>
#               <tem:RMS_InventLocationServiceFindRequest>
#                  <!--Optional:-->
#                  <quer:QueryCriteria>
#
#                  </quer:QueryCriteria>
...
#            </soapenv:Body>
#         </soapenv:Envelope>'''
#     headers = [("SOAPAction", "http://tempuri.org/RMS_InventLocationService/find"),
#                ("Content-Type", "text/xml;charset=utf-8")]
#     url = "http://172.70.0.49:801/MicrosoftDynamicsAXAif60/RMSInventLocation/xppservice.svc"
#
