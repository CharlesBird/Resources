...
sns.relplot(x="pct_chg_1y", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_6m", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_5m", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_4m", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_3m", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_2m", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_1m", y="pct_chg", hue="rise", data=df)

sns.relplot(x="pct_chg_1w", y="pct_chg", hue="rise", data=df)
