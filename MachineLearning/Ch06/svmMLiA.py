...
# print(b, alphas[alphas>0], shape(alphas[alphas>0]))
# for i in range(100):
#     if alphas[i] > 0:
...
# print(dataMat[1]*mat(ws)+b, labelArr[1])
# print(dataMat[2]*mat(ws)+b, labelArr[2])
# print(dataMat[3]*mat(ws)+b, labelArr[3])
# print(dataMat[4]*mat(ws)+b, labelArr[4])
